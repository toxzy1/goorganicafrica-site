(function () {
  ...
  function getCommodityCountryData(commodity, countryCode) {
    return commodity && commodity.country_data ? commodity.country_data[countryCode] : null;
  }
  ...
  function renderCountryStep() {
    stepHeader(root, "Step 1 of 8", "Select Your Country");
  ...
  function renderRegionStep() {
    stepHeader(root, "Step 2 of 8", "Select Your Region");
  ...
  function renderTypeStep() {
    stepHeader(root, "Step 3 of 8", "What Are You Farming?");
    var grid = document.createElement("div");
    grid.className = "calc-option-grid";
    [
      { id: "crop", label: "Crop", emoji: "\ud83c\udf3e" },
